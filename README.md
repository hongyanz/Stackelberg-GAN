...
* gan_branch_mG.py is a demo on the performance of multi-branch GAN on Gaussian mixture dataset,
* gan_ensemble_mnist.py is a demo on the performance of Stackelberg GAN on MNIST dataset,
