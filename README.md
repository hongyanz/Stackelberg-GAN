...
## Install
This code depends on python 3.6, pytorch 0.4.1 and Tensorflow (version>=1.4.1, for CIFAR-10 experiments). We suggest to install the dependencies using Anaconda or Miniconda. Here is an exemplary command:
```
